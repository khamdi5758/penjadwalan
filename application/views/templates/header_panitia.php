    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#index.html">panitia</a>
            </div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="<?= baseurl; ?>/halpanitia"><i class="fa fa-dashboard fa-3x"></i> Dashboard</a>
                    </li>
                    <li>
                        <a href="<?= baseurl; ?>/halpanitia/validvoting"><i class="fa fa-desktop fa-3x"></i>validasi voting </a>
                    </li>
                    <li>
                        <a href="<?= baseurl; ?>/halpanitia/datadiri"><i class="fa fa-qrcode fa-3x"></i> Data Diri</a>
                    </li>
