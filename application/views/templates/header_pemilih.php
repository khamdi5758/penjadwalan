    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#index.html">peserta</a>
            </div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="<?= baseurl; ?>/halpemilih"><i class="fa fa-dashboard fa-3x"></i> Dashboard</a>
                    </li>
                    <li>
                        <a href="<?= baseurl; ?>/halpemilih/voting"><i class="fa fa-desktop fa-3x"></i> voting </a>
                    </li>
                    <li>
                        <a href="<?= baseurl; ?>/halpemilih/datadiri"><i class="fa fa-qrcode fa-3x"></i> Data Diri</a>
                    </li>
